...
echo '<tr>';
echo '<td>';
echo Html::a('+3 баллов', \yii\helpers\Url::to(['site/plus-score', 'numb' => 3, 'id' => $model->id, 'branch' => 1]), ['class' => 'btn btn-success inline']);
echo '</td>';
echo '<td>';
echo Html::a('-3 баллов', \yii\helpers\Url::to(['site/minus-score', 'numb' => 3, 'id' => $model->id, 'branch' => 1]), ['class' => 'btn btn-danger inline']);
echo '</td>';
echo '</tr>';
echo '<tr>';
echo '<td>';
